...
public class Event {
    ...
    // Methods to add and remove students from the registered students list
    ...
    // Method to check if the event is at capacity
    public boolean isFull() {
        return registeredStudents.size() >= capacity;
    }

    // Method to check if a student is registered (Updated method call)
